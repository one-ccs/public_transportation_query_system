 ...
 */
export default function encryptMD5(text: string){
	...
	function md5_ConvertToWordArray(text: string) {
         var lWordCount;
         var lMessageLength = text.length;
         ...
         while ( lByteCount < lMessageLength ) {
                 ...
                 lWordArray[lWordCount] = (lWordArray[lWordCount] | (text.charCodeAt(lByteCount)<<lBytePosition));
                 lByteCount++;
         }
         lWordCount = (lByteCount-(lByteCount % 4))/4;
         lBytePosition = (lByteCount % 4)*8;
	...
	function md5_Utf8Encode(text: string){
         text = text.replace(/\r\n/g,"\n");
         var utftext = "";
	...
	text = md5_Utf8Encode(text);
	x = md5_ConvertToWordArray(text);
